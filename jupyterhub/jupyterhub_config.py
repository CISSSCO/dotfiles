...
# c.ConfigurableHTTPProxy.api_url = 'http://127.0.0.1:9001'     # changes by rabhishek
c.ConfigurableHTTPProxy.api_url = 'http://127.0.0.1:9001'

c.JupyterHub.port = 8005  # or any other available port
#c.JupyterHub.hub_port = 8590
c.JupyterHub.ip ='0.0.0.0'

c.JupyterHub.authenticator_class = 'ldapauthenticator.LDAPAuthenticator'
#c.LDAPAuthenticator.server_hosts =  ['ldap://172.10.0.3:389']
c.LDAPAuthenticator.server_address = 'ldap://172.10.0.3:389'
#c.LDAPAuthenticator.server_port = 389 # Or your LDAP port
#c.LDAPAuthenticator.bind_dn_template = 'uid=cdacapp02,ou=CDAC,dc=rudradelhi,dc=nsm,dc=in' # Adjust according to your LDAP structure
##c.LDAPAuthenticator.user_search_base = 'dc=rudradelhi,dc=nsm,dc=in'
#c.LDAPAuthenticator.use_ssl=True
c.NotebookApp.shutdown_no_activity_timeout = 600

c.LDAPAuthenticator.bind_dn_template = [
    "uid={username},ou=People,dc=rudradelhi,dc=nsm,dc=in",
    "uid={username},ou=Group,dc=rudradelhi,dc=nsm,dc=in",
    "uid={username},ou=CDAC,dc=rudradelhi,dc=nsm,dc=in",
    "uid={username},ou=support,dc=rudradelhi,dc=nsm,dc=in",
    "uid={username},ou=CDACD,dc=rudradelhi,dc=nsm,dc=in",
    "uid={username},ou=nsmhrd,dc=rudradelhi,dc=nsm,dc=in"
]
...
c.JupyterHub.bind_url = 'http://127.0.0.1:8005/jhub/'

# c.Spawner.cmd = ['bash', '-c', 'source /home/apps/jupyter/miniconda3/etc/profile.d/conda.sh && conda activate jupyterhub && jupyterhub-singleuser']             # by_abhishek
#------------------------------------------------------------------------------
...
# c.JupyterHub.log_file = '/var/log/jupyterhub/jhub.log'

# Disable the access and failed logs if you want everything in one log
#c.JupyterHub.access_log = False  # Disable access logs being split
#c.JupyterHub.failed_log = False  # Disable failed log being split
...
log_file_path = os.path.join(log_dir, 'jhub.log')
...
c.JupyterHub.log_file = log_file_path  # Path to the log file
c.JupyterHub.log_level = 'DEBUG'  # Set desired log level (DEBUG, INFO, etc.)
c.JupyterHub.extra_log_file = log_file_path  # Also log to this file
...
# Add the handler to JupyterHub's logger
...
#                 "level": "DEBUG",
#                 "filename": "</var/log/jupyterhub/jhub.logs>",
#             }
#         },
 #        "loggers": {
 #            "<application-name>": {
...
#  Default: 1800
c.JupyterHub.active_user_window = 100
...
#          .. versionadded:: 4.1
#  Default: False
#c.JupyterHub.cookie_host_prefix_enabled = True    # by_rabhishek
...
#  Default: '/home/apps/jupyter/miniconda3/envs/jupyterhub/share/jupyterhub'
# c.JupyterHub.data_files_path = '/home/apps/jupyter/miniconda3/envs/jupyterhub/share/jupyterhub'
...
#  Default: ''
#c.JupyterHub.ssl_cert = '/etc/letsencrypt/live/paramrudra.cdacdelhi.in/cert.pem'

## Path to SSL key file for the public facing interface of the proxy
#  
#          When setting this, you should also set ssl_cert
#  Default: ''
#c.JupyterHub.ssl_key = '/etc/letsencrypt/live/paramrudra.cdacdelhi.in/privkey.pem'
...
#  
#          If `delete_nvalid_users` is True,
